...
<html>
		...
		<body>
			...
			<div class="row" style="margin-top: 10px;">
				...
				<li class="active"><a data-toggle="tab" href="#products">TAB 1</a></li>
				<li><a href="home2.php">TAB 2</a></li>
			</ul>
			...
			<div class="row m-l">
				<div class="tab-content col-md-8 white-bg">
					<div id="products" class="tab-pane fade in active">
						<?php
							$query = "SELECT * FROM product_mother ORDER BY id ASC";
						...
						?>
														...
														<div class="row">
															<div class="col-sm-12 bottom-align">
																		<input type="radio" id="oz" name="size" value="12oz" checked hidden/><br>
												<input type="radio" name="size" value="16oz" hidden/>
					...
					<div class="col-md-4 col-xs-12">
							...
							<thead>
								...
								<tr class="active">
									<th class="col-md-5" style="vertical-align: middle;">Product Name</th>
									<!-- <th class="col-md-1" style="vertical-align: middle;">Size</th> -->
									<th class="col-md-3" style="vertical-align: middle;"`>Quantity</th>
									<th class="col-md-3" style="vertical-align: middle;"`>Price</th>
									<th class="col-md-3" style="vertical-align: middle;"`>Total</th>
									<th class="col-md-5" style="vertical-align: middle;">Action

									<form action = "clear.php" method="post" >
										<button class="btn btn-danger btn-xs" <?php if(empty($_SESSION["shopping_cart"])){ ?> disabled <?php   } ?> onClick="return confirm('Are you sure you want to clear?');" data-toggle="tooltip" data-placement="top" title="Clear all">										
											...
											<table class="table table-bordered table-condensed white-bg text-center" style="margin: 0; width: 100%; font-size: 1em;">
												...
												?>
																<tr >
																	...
																	<td class="col-md-3" style="vertical-align: middle;"><button name="<?php echo $values["product_size"]?>" onclick = "disab()" class="btn btn-danger btn-xs delete custom-button" id="<?php echo $values["product_id"]; ?>">Remove</button></td>
																</tr>
							...
							<tfoot>
								<!-- <tr>
									...
									<td style="vertical-align: middle;"><input type="submit" class="btn btn-warning btn-xs pull-lg-left"  data-dismiss="modal" data-toggle="modal" data-target="#modal-3" class="fa fa-unlock-alt" value="Add Discount" name="submit"></td>
								</tr> -->
					...
					<div class="container" style="">
						...
						<a data-dismiss="modal" onclick="id02"><button type="button" class="cancelbtn btn btn-success">Proceed</button></a>
				...
				<div class="modal-dialog modal-sm" role="document">
						<div class="modal-content">
							...
							<form method="post" action="">
								<input type="number" min="0" required="required" placeholder="Enter Amount" id="amount" name="amount" style="height:50px;"/>
								<p id="error"/></p>

							</div>

							<div class="modal-footer">
							<input type="submit" class="btn btn-success pull-lg-left" data-dismiss="modal" data-toggle="modal" data-target="#modal-2" onclick="k()"class="fa fa-unlock-alt" value="Proceed" name="submit">
				...
				<form action="submit_process.php" method="post">
					...
					<div class="modal-dialog modal-sm" role="document">
							<div class="modal-content">
								...
								<input type="submit" class="btn btn-success pull-lg-left" name="Submit" id="submitbutton" onClick="return confirm('Are you sure you would like to submit this order?'); al();"/>
								<button type="button" class="btn btn-warning pull-lg-left" id="backbutton" data-dismiss="modal" data-toggle="modal" data-target="#modal-1"><i class="fa fa-unlock-alt"></i>Back</button>
									</div>
							</div>
					</div>
					</div>
					...
					<div class="modal-dialog modal-sm" role="document">
							<div class="modal-content">
								<div class="modal-header bg-info">										
										<h4 class="modal-title"><b>Senior Citizen</b></h4>
								</div>
							<div class="modal-body">
							<!--	<p id ="demo1"/>
								<p id="demo2"/>
								<p id ="demo3"/> -->
							<input type="radio" name="type" value="solo" required="required" checked onChange="findselected()"/>Solo<br>
							...
							document.getElementById("inputtext").removeAttribute('disabled');
								...
								<input type="submit" class="btn btn-success pull-lg-left" name="Submit" class="senior" id="submitbutton" onClick="return confirm('Are you sure you want to add discount?'); al();"/>
								<input type="submit" class="btn btn-warning pull-lg-left" class="fa fa-unlock-alt" value="Cancel" data-dismiss="modal" aria-label="Close"/>
									</div>
							</div>
					</div>
